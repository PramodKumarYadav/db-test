...
class CreateExpectedCSVFileTest {
    ...
    void generateExpectedCSVFileFromActualSQLOutput() throws java.io.IOException {
        ...
        List<Map<String, String>> actualRows = db.executePreparedStatement("SELECT * FROM customer");

        // Generate expected csv file.
        CsvUtils.writeMapListToCsv("src/test/resources/testdata/expected_customer_data.csv", actualRows);

        // Verify the generated CSV file
        List<Map<String, String>> expectedRows = CsvUtils.readCsvToMapList("src/test/resources/testdata/expected_customer_data.csv");
